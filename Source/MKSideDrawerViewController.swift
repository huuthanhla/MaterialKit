...
public class MKSideDrawerViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    public var mainViewController: UIViewController! {
        didSet {
            ...
            let viewDictionary: [String: Any] = ["mainView" : mainViewController.view!]
    ...
    public var drawerViewController : UIViewController? {
        didSet {
            ...
            let viewDictionary: [String: Any] = ["drawerView" : drawerViewController.view!]
    ...
    override public func viewDidLoad() {
        ...
        let viewDictionary: [String: Any] = ["_containerView": _containerView]
